...
const contractABI = require("../artifacts/contracts/Tweeteriris.sol/Tweeteriris.json").abi;

program
    .name("tweeteriris-cli")
    .description("CLI tool for Tweeteriris smart contract")
    .version("1.0.0");
