 ...
 * This file demonstrates how to integrate Tweeteriris with a web frontend
 */

// For React/Vue/Angular applications
export class TweeteririsClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TweeteririsClient(provider, contractAddress);
